            ...
            if (activeTab === "kepala") {
                ...
                if (formData.foto_kades instanceof File) {
                    ...
                    const { error } = await supabase.storage
                        ...
                        .upload(filePath, formData.foto_kades, {
                            upsert: true,
                        });
                ...
                if (formData.struktur_organisasi instanceof File) {
                    const ext = formData.struktur_organisasi.name
                        .split(".")
                        .pop();
                    ...
                    const { error } = await supabase.storage
                        .from("cms-desa-cikelat")
                        .upload(filePath, formData.struktur_organisasi, {
                            upsert: true,
                        });

                    if (error) throw error;

                    strukturUrl = getImageUrl(filePath);
                }
                                            ...
                                            <div className="flex justify-between items-center">
                                                ...
                                                <button
                                                    onClick={() => {
                                                        setFormData({
                                                            nama_kepala_desa:
                                                                profilData.nama_kepala_desa ||
                                                                "",
                                                            jabatan_kepala_desa:
                                                                profilData.jabatan_kepala_desa ||
                                                                "",
                                                            sambutan:
                                                                profilData.sambutan ||
                                                                "",
                                            ...
                                            <div className="flex justify-between items-center">
                                                ...
                                                <button
                                                    onClick={() => {
                                                        setFormData({
                                                            struktur_organisasi:
                                                                profilData.struktur_organisasi ||
                                                                "",
                                                            nama_organisasi:
                                                                profilData.nama_organisasi ||
                                                                "",
                                                            periode_struktur:
                                                                profilData.periode_struktur ||
                                                                "",
                                                        });
                                                        setEditStrukturModalOpen(
                                                            true
                                                        );
                                                    }}
                                                    className="bg-[#129990]/20 text-[#129990] hover:bg-[#129990] hover:text-white px-4 py-2 rounded-md transition font-medium"
